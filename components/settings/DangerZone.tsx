  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="glass-card-dynamic border-teal"><CardContent className="p-4 space-y-3">
        <div className="flex items-center justify-between p-3 rounded-lg border border-teal bg-teal-card">
          <div>
          ...
          <Button variant="outline" className="border-teal text-slate-300 hover:bg-teal-card/50" onClick={()=> addToast(createSuccessToast('Signed out', 'All sessions invalidated'))}>Sign out all</Button>
        </div>
        <div className="flex items-center justify-between p-3 rounded-lg border border-teal bg-teal-card">
          <div>
