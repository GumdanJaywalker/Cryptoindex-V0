          ...
          <CardContent className="p-4 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <Input name="name" value={form.name} onChange={onChange} placeholder="Your name" className="glass-input border-teal" />
              </div>
              <div>
                <div className="text-xs text-slate-400 mb-1">Email</div>
                <Input name="email" value={form.email} onChange={onChange} placeholder="you@example.com" className="glass-input border-teal" />
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                <div className="text-xs text-slate-400 mb-1">Twitter/X</div>
                <Input name="twitter" value={form.twitter} onChange={onChange} placeholder="@handle" className="glass-input border-teal" />
              </div>
              <div>
                <div className="text-xs text-slate-400 mb-1">YouTube</div>
                <Input name="youtube" value={form.youtube} onChange={onChange} placeholder="channel URL" className="glass-input border-teal" />
              </div>
              <div>
                <div className="text-xs text-slate-400 mb-1">TikTok</div>
                <Input name="tiktok" value={form.tiktok} onChange={onChange} placeholder="@handle" className="glass-input border-teal" />
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                <div className="text-xs text-slate-400 mb-1">Avg. Views per Post</div>
                <Input name="avgViews" value={form.avgViews} onChange={onChange} placeholder="e.g. 20,000" className="glass-input border-teal" />
              </div>
              <div>
                <div className="text-xs text-slate-400 mb-1">Followers (primary channel)</div>
                <Input name="followers" value={form.followers} onChange={onChange} placeholder="e.g. 120,000" className="glass-input border-teal" />
              </div>
            </div>
            <div>
              <div className="text-xs text-slate-400 mb-1">Notes</div>
              <Textarea name="notes" value={form.notes} onChange={onChange} placeholder="Tell us about your audience and previous promotions" className="glass-input border-teal min-h-[120px]" />
            </div>
            <div className="flex justify-end gap-2">
              <Link href="/referrals" className="text-xs px-3 py-2 rounded-md glass-button-brand">Cancel</Link>
