...
exports.UltraPerformanceOrderbook = void 0;
const ioredis_1 = require("ioredis");
const events_1 = require("events");
const worker_threads_1 = require("worker_threads");
const msgpack = require("msgpack-lite");
class UltraPerformanceOrderbook extends events_1.EventEmitter {
    constructor() {
        super();
        this.pipeline = null;
        this.batchQueue = [];
  ...
  `;
    ...
    async processOrderAtomic(order) {
        ...
        const result = await this.redis.matchOrder(orderbook_key, order_data_key, order.id, order.price, order.amount, order.side, Date.now().toString());
    ...
    async getOrderbookCached(pair, depth = 20) {
        ...
        await this.redis.setex(cacheKey, 1, // 1 second cache
...
exports.UltraPerformanceOrderbook = UltraPerformanceOrderbook;
