...
exports.redisPubSub = exports.redis = void 0;
exports.getRedisClient = getRedisClient;
exports.closeRedisConnection = closeRedisConnection;
exports.isUsingFallback = isUsingFallback;
...
const fallback_client_1 = require("./fallback-client");
            ...
            redisClient = new ioredis_1.Redis(redisUrl, {
                ...
                reconnectOnError: (err) => {
                    ...
                    if (!useFallback) {
                        ...
                        useFallback = true;
                        redisClient = new fallback_client_1.RedisFallbackClient();
                    }
                    return false;
                },
...
exports.redisPubSub = getRedisClient;
