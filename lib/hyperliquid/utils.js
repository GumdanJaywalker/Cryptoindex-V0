 ...
 */
export const isUserOnHyperliquidNetwork = async () => {
    try {
 ...
 */
export const checkWalletHyperliquidUsage = async (walletAddress) => {
    try {
        ...
        console.error('Failed to check Hyperliquid usage:', error);
        return {
 ...
 */
export const getCachedHyperliquidUsage = (walletAddress) => {
    try {
 ...
 */
export const showMarginWarning = (totalMarginUsed, availableMargin) => {
    const warnings = [];
