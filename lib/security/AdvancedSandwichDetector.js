...
export class AdvancedSandwichDetector {
     ...
     */
    analyzeOrderPattern(orders, targetOrder // 샌드위치 대상 주문
    ) {
        // 1. TP/SL 주문 체크 (가장 먼저)
     ...
     * 진짜 샌드위치 공격 감지
     */
    checkRealSandwich(orders, targetOrder) {
     ...
     * 사용자 패턴 학습 및 업데이트
     */
    updateUserPattern(userId, trades) {
