...
export class HyperVMAMM {
    ...
    constructor(providerUrl, contractAddresses) {
        ...
        this.routerContract = new ethers.Contract(contractAddresses.router, ROUTER_ABI, this.provider);
    }
    /**
    ...
    connectSigner(signer) {
        this.signer = signer;
        this.routerContract = new ethers.Contract(this.contracts.router, ROUTER_ABI, signer);
    }
    /**
    ...
    async getPairReserves() {
        const pairContract = new ethers.Contract(this.contracts.pair, PAIR_ABI, this.provider);
