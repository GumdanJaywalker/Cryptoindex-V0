...
export function rateLimit(identifier, maxRequests = 100, windowMs = 15 * 60 * 1000 // 15분
) {
    const now = Date.now();
 ...
 * IP 기반 Rate Limiting
 */
export function rateLimitByIP(request, maxRequests = 1000, windowMs = 15 * 60 * 1000) {
 ...
 */
export function rateLimitByUser(userId, maxRequests = 1000, windowMs = 60 * 60 * 1000) {
