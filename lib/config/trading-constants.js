...
export const API_CONFIG = {
    ...
    VALIDATION: {
        ...
        MAX_PRICE_LENGTH: 20,
        SUPPORTED_PAIRS: ['HYPERINDEX-USDC'],
...
export const isValidPair = (pair) => {
    return API_CONFIG.VALIDATION.SUPPORTED_PAIRS.includes(pair);
};
export const isValidOrderType = (type) => {
    return API_CONFIG.VALIDATION.SUPPORTED_ORDER_TYPES.includes(type);
};
export const isValidOrderSide = (side) => {
    return API_CONFIG.VALIDATION.SUPPORTED_SIDES.includes(side);
};
